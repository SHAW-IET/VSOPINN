...
OUT_DIR = "./output/improved/recomputed_boundary_2pts_center_2pts/3 hard_Voronoi"
...
try:
    ...
    print(f"Voronoi visualization saved to {OUT_DIR}")
except Exception as e:
    print(f"Voronoi visualization generation failed: {e}")
