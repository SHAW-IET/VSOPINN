...
from voronoi_utils import VaryGeoDataset_PairedSolutionOld, to4DTensor, LearnableKeyPoints,\
    VaryGeoDataset_PairedSolution, softVoronoi, select_key_indices
...
save_dir = Path(r"./output/improved_1.28_data_records/4 optimized_sensors")
...
print("Initial Key point indices:", key_indices)
