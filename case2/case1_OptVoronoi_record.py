...
# [配置] 文件保存路径
# =============================================================================
save_dir = Path(r"./output/2026.1.28完善数据记录/4 优化测点")
...
if __name__ == '__main__':
    ...
    # [关键修复] 直接传入 U_ref, V_ref, P_ref 完整场 (2D Tensor)，而不是采样后的标量
    # U_ref shape is (1, 1, ny, nx) -> U_ref[0, 0] is (ny, nx)
    voronoi_input_final = softVoronoi(
        coord_2d,
        U_ref[0, 0], V_ref[0, 0], P_ref[0, 0],  # 使用完整场作为源，用于插值
        key_positions,
