...
if RUN_MODE == 'OPTIMIZE':
    ...
    if INIT_STRATEGY == 'RANDOM':
        ...
        print(f"    Using random seed: {INIT_SEED}")
        g = torch.Generator()
    ...
    print(">>> Validation mode: using fixed cluster centers...")
    initial_positions = torch.tensor(FIXED_SENSOR_CENTROIDS, dtype=torch.float32)
    print(f"Fixed initial positions:\n{initial_positions}")
...
if __name__ == '__main__':
    ...
    out_dir = "./output/improved/10 with_data_points - optimized_data_points - multi_conditions - CVT - validation/"
    ...
    if RUN_MODE == 'OPTIMIZE':
        ...
        save_prefix = f"Val_{current_case_name}"
