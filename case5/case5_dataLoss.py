...
SAVE_DIR = BASE_DIR / 'output' / 'output_heat_dataLoss'
...
if __name__ == '__main__':
    ...
    plt.xlabel('Epoch')
    plt.ylabel('Loss')
    plt.title('Training Loss Convergence (PDE)')
    plt.legend()
    plt.grid(True)
    ...
    plt.title('Temperature Relative L2 Error Convergence')
    plt.legend()
    plt.grid(True)
    ...
    plt.xlabel('Epoch')
    plt.ylabel('MSE')
    plt.title('Temperature MSE Convergence')
    plt.legend()
    plt.grid(True)
